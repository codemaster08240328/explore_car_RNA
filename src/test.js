      ...
      <View style={styles.container}>
        ...
        <View style={styles.sliders}>
          ...
          <MultiSlider
            ...
            step={1}
            allowOverlap={false}
            containerStyle={{height:30, display: 'flex', alignItems: 'center', justifyContent: 'center'}}
            trackStyle={{height: 10, borderRadius: 5}}
            selectedStyle={{backgroundColor:'#007cca'}}
            markerStyle={{borderWidth: 1, borderColor: '#9a9a9a', marginTop:10 ,height:20, width: 20, backgroundColor: '#c2c4c5'}}
